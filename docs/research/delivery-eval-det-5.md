...
| **Enrichment**| Attributes Populated in CSV | **15** (Avg: 3.0/product) | Delivery Triplets |
| **Delivery** | Overall Delivery Completeness | **8.65%** (Avg: 21.8/252 fields) | Non-empty Delivery Fields |
...
| **Attributes** | **4.0%** | ATTRIBUTE_LABEL 1..50, ATTRIBUTE_VALUE 1..50, ATTRIBUTE_UOM 1..50 |
| **URLs** | **3.33%** | MFR URL, Ref URL 1..5 |
| **Assets & Documents** | **0.0%** | Specification Sheet, Manuals, SDS, Images, CAD drawings |
| **Commercial & Packaging** | **22.35%** | SKU, Packaging, Dimensions, Weights, Volumes |
| **Overall Average** | **8.65%** | Average across all 252 observed delivery columns |
